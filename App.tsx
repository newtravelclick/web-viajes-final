...
// Asegúrate de que geminiService.ts está en tu lista de archivos.
...
const BLOG_CONTENT: Record<string, string> = {
  '1': `
    <h1 style="color:#0071BC;font-size:2.5rem;font-weight:800;margin-bottom:20px;">1. RUTA POR LA COSTA BRAVA: CALAS SECRETAS Y PUEBLOS DE PESCADORES</h1>
    ...
    <p class="intro" style="font-size:1.2rem;line-height:1.8;color:#444;margin-bottom:30px;">La Costa Brava no es solo un destino, es un estado de ánimo. Pinos que tocan el mar, aguas turquesas y una gastronomía que enamora. Aquí tienes tu hoja de ruta para 5 días inolvidables.</p>

    <h2 style="color:#0071BC;margin-top:40px;font-size:1.8rem;border-bottom:2px solid #0071BC;padding-bottom:10px;">🗺️ El Itinerario</h2>
    ...
    <h2 style="color:#0071BC;margin-top:40px;font-size:1.8rem;border-bottom:2px solid #0071BC;padding-bottom:10px;">🎒 Qué hacer (Imprescindibles)</h2>
    <ol style="line-height:1.8;font-size:1.1rem;margin-bottom:30px;">
    ...
    <h2 style="color:#0071BC;margin-top:40px;font-size:1.8rem;border-bottom:2px solid #0071BC;padding-bottom:10px;">🍽️ Dónde comer</h2>
    <ul style="list-style-type:disc;padding-left:20px;line-height:1.8;font-size:1.1rem;">
    ...
    <h2 style="color:#0071BC;margin-top:40px;font-size:1.8rem;border-bottom:2px solid #0071BC;padding-bottom:10px;">🚫 Lo que no te puedes perder</h2>
    <p style="font-size:1.1rem;">Ver amanecer desde el Faro del Cap de Creus. Es el punto más oriental de la península ibérica; serás la primera persona en ver salir el sol en España ese día.</p>

    <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:40px 0;border-radius:8px;">
      <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
      <p style="margin-top:10px;color:#333;font-size:1.1rem;">En verano, los parkings de las calas famosas se llenan a las 09:00 AM. Si quieres aparcar y tener sitio para la toalla, madruga. Si vas fuera de temporada (junio o septiembre), tendrás el paraíso para ti solo.</p>
    </div>
  `,
  '2': `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#333;line-height:1.6;max-width:800px;margin:0 auto;">
      ...
      <h1 style="color:#0071BC;font-size:2.5rem;margin-bottom:20px;font-weight:800;">Escapada Imperial: Praga y Budapest, Dos Joyas del Danubio</h1>

      <img src="https://images.unsplash.com/photo-1541849546-2165492d06d6?auto=format&fit=crop&w=1200&q=80" alt="Fotografía panorámica al atardecer del Parlamento de Budapest iluminado reflejándose en el río Danubio" style="width:100%;height:auto;border-radius:12px;margin-bottom:25px;">

      <p class="intro" style="font-size:1.2rem;margin-bottom:30px;">
      ...
      <h2 style="color:#0071BC;border-bottom:2px solid #0071BC;padding-bottom:10px;margin-top:40px;font-size:1.8rem;">🗺️ El Itinerario</h2>
      ...
      <h2 style="color:#0071BC;border-bottom:2px solid #0071BC;padding-bottom:10px;margin-top:40px;font-size:1.8rem;">🎒 Qué hacer (Imprescindibles)</h2>
      
      <img src="https://images.unsplash.com/photo-1565426873118-a17ed65d7429?auto=format&fit=crop&w=1200&q=80" alt="Primer plano de una persona sosteniendo un dulce Trdelník en una calle empedrada de Praga" style="width:100%;height:auto;border-radius:12px;margin:25px 0;">
      ...
      <h2 style="color:#0071BC;border-bottom:2px solid #0071BC;padding-bottom:10px;margin-top:40px;font-size:1.8rem;">🍽️ Dónde comer</h2>
      <ul style="list-style-type:circle;padding-left:20px;font-size:1.1rem;">
      ...
      <h2 style="color:#0071BC;border-bottom:2px solid #0071BC;padding-bottom:10px;margin-top:40px;font-size:1.8rem;">🚫 Lo que no te puedes perder</h2>
      <p style="font-size:1.1rem;">Ver los <strong>Zapatos en la orilla del Danubio</strong> en Budapest. Un monumento sencillo pero estremecedor que te conecta con la historia judía de la ciudad.</p>

      <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:30px 0;border-radius:5px;">
        <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
        <p style="margin:10px 0 0 0;font-size:1.1rem;">Ojo con la moneda. Ninguna de las dos ciudades usa Euro (usan Coronas Checas y Florines Húngaros). Evita cambiar dinero en el aeropuerto; saca directamente de cajeros oficiales en la ciudad para mejor cambio.</p>
      </div>
    </div>
  `,
  '3': `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#333;line-height:1.6;max-width:800px;margin:0 auto;">
      ...
      <h1 style="color:#0071BC;font-size:2.5rem;margin-bottom:20px;font-weight:800;">Japón Milenario: Un Viaje entre Templos y Neones</h1>

      <img src="https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1200&q=80" alt="Icónica vista de la Pagoda Chureito con el Monte Fuji de fondo y ramas de cerezo en flor" style="width:100%;height:auto;border-radius:12px;margin-bottom:25px;">
      ...
      <img src="https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&w=1200&q=80" alt="Callejón nocturno en Tokio iluminado por neones y farolillos rojos" style="width:100%;height:auto;border-radius:12px;margin:25px 0;">
      ...
      <h2 style="color:#0071BC;border-bottom:2px solid #0071BC;padding-bottom:10px;margin-top:40px;font-size:1.8rem;">🚫 Lo que no te puedes perder</h2>
      <p style="font-size:1.1rem;">El barrio de <strong>Gion en Kioto</strong> al atardecer. Si tienes suerte y eres respetuoso, podrás ver pasar a una Geisha o Maiko camino a una cita. Es como viajar 300 años atrás en el tiempo.</p>

      <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:30px 0;border-radius:5px;">
        <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
        <p style="margin:10px 0 0 0;font-size:1.1rem;">En Japón no se deja propina (se considera ofensivo) y no se habla por teléfono en los trenes. La etiqueta y el respeto al prójimo son sagrados. ¡Lleva calcetines limpios y sin agujeros, te descalzarás mucho!</p>
      </div>
    </div>
  `,
  '4': `
    ...
    <p class="intro" style="font-size:1.2rem;line-height:1.6;color:#444;margin-bottom:30px;">Un viaje que despierta los sentidos. Desde la grandiosidad de la Alhambra hasta el olor a azahar de Sevilla. Esta ruta del "Triángulo de Oro" es un clásico que nunca falla.</p>

    <h2 style="color:#0071BC;margin-top:40px;font-size:1.8rem;border-bottom:2px solid #0071BC;">🗺️ El Itinerario</h2>
    <ul style="list-style: none; padding-left: 0; line-height: 1.8; font-size:1.1rem;">
    ...
    <h2 style="color:#0071BC;margin-top:40px;font-size:1.8rem;border-bottom:2px solid #0071BC;">🎒 Qué hacer (Imprescindibles)</h2>
    <ol style="line-height: 1.8; margin-bottom: 30px; font-size:1.1rem;">
      <li style="margin-bottom: 10px;"><strong>Espectáculo de Flamenco:</strong> En el barrio de Triana (Sevilla) o en las cuevas del Sacromonte (Granada). Busca los locales pequeños y familiares ("tablaos").</li>
    ...
    <h2 style="color:#0071BC;margin-top:40px;font-size:1.8rem;border-bottom:2px solid #0071BC;">🍽️ Dónde comer</h2>
    <ul style="list-style-type: disc; padding-left: 20px; line-height: 1.8; font-size:1.1rem;">
    ...
    <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:40px 0;border-radius:8px;">
      <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
      <p style="margin-top:10px;color:#333;font-size:1.1rem;">Andalucía en julio y agosto puede superar los 40°C. Organiza tus visitas a monumentos a primera hora de la mañana (09:00h) y deja las tardes para museos con aire acondicionado o paseos nocturnos. ¡La siesta aquí es una necesidad, no un capricho!</p>
    </div>
  `,
  '5': `
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#333;line-height:1.6;max-width:800px;margin:0 auto;">

  <h1 style="color:#0071BC;font-size:2.5rem;margin-bottom:20px;font-weight:800;">Fiordos Noruegos: Donde la Naturaleza Reina</h1>

  <img src="https://images.unsplash.com/photo-1507272931001-fc06c17e4f43?auto=format&fit=crop&w=1200&q=80" alt="Paisaje épico de un fiordo noruego" style="width:100%;height:auto;border-radius:12px;margin-bottom:25px;">
  ...
  <img src="https://images.unsplash.com/photo-1520633908316-6415e982d61d?auto=format&fit=crop&w=1200&q=80" alt="Vista desde la ventana del tren de Flam" style="width:100%;height:auto;border-radius:12px;margin:25px 0;">
  ...
  <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:30px 0;border-radius:5px;">
    <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
    <p style="margin:10px 0 0 0;font-size:1.1rem;">El clima noruego es impredecible incluso en verano. Viste siempre por capas ("teoría de la cebolla") y lleva un chubasquero de calidad. ¡No dejes que la lluvia te pare!</p>
  </div>
</div>
  `,
  '6': `
  ...
  <h1 style="color:#0071BC;font-size:2.5rem;margin-bottom:20px;font-weight:800;">Safari Kenia y Tanzania: En Busca de los Cinco Grandes</h1>
  ...
  <img src="https://images.unsplash.com/photo-1535591273668-578e31182c4f?auto=format&fit=crop&w=1200&q=80" alt="Primer plano de un león macho descansando sobre una roca" style="width:100%;height:auto;border-radius:12px;margin:25px 0;">
  ...
  <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:30px 0;border-radius:5px;">
    <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
    <p style="margin:10px 0 0 0;font-size:1.1rem;">Viste con colores neutros (caqui, verde oliva, beige). Evita el azul oscuro y el negro, ya que atraen a la mosca tsetsé. Y no olvides unos buenos prismáticos; la diferencia entre ver una mancha y ver un leopardo está en la óptica.</p>
  </div>
</div>
  `,
  '7': `
    ...
    <p class="intro" style="font-size:1.2rem;line-height:1.6;color:#444;margin-bottom:30px;">Si te gusta comer bien y los paisajes que parecen Suiza pero con mar, esta ruta por Euskadi y Cantabria es para ti. Prepara el apetito.</p>
    ...
    <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:40px 0;border-radius:8px;">
      <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
      <p style="margin-top:10px;color:#333;font-size:1.1rem;">En el norte el clima cambia en minutos ("Orbayu" o "Sirimiri"). Lleva siempre un chubasquero ligero y calzado cómodo que no resbale. Y recuerda: las raciones de comida en el norte son muy generosas. ¡Cuidado al pedir!</p>
    </div>
  `,
  '8': `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#333;line-height:1.6;max-width:800px;margin:0 auto;">

  <h1 style="color:#0071BC;font-size:2.5rem;margin-bottom:20px;font-weight:800;">La Toscana: Ruta entre Viñedos y Renacimiento</h1>
  ...
  <img src="https://images.unsplash.com/photo-1596700877903-88849646c10e?auto=format&fit=crop&w=1200&q=80" alt="Dos copas de vino tinto Chianti" style="width:100%;height:auto;border-radius:12px;margin:25px 0;">
  ...
  <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:30px 0;border-radius:5px;">
    <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
    <p style="margin:10px 0 0 0;font-size:1.1rem;">Si alquilas coche, ¡cuidado con las ZTL (Zonas de Tráfico Limitado)! Están en el centro de casi todos los pueblos y ciudades. Si entras sin permiso, la multa te llegará a casa meses después.</p>
  </div>
</div>
  `,
  '9': `
  ...
  <h1 style="color:#0071BC;font-size:2.5rem;margin-bottom:20px;font-weight:800;">Nueva York: Guía de la Ciudad que Nunca Duerme</h1>
  ...
  <img src="https://images.unsplash.com/photo-1499092346589-b9b6be3e94b2?auto=format&fit=crop&w=1200&q=80" alt="Vista icónica del Puente de Brooklyn" style="width:100%;height:auto;border-radius:12px;margin:25px 0;">
  ...
  <div style="background-color:#E3F2FD;border-left:5px solid #0071BC;padding:20px;margin:30px 0;border-radius:5px;">
    <p style="margin:0;font-weight:bold;color:#0071BC;font-size:1.2rem;">💡 Consejo New Travel Click</p>
    <p style="margin:10px 0 0 0;font-size:1.1rem;">Recuerda sacar tu ESTA (visado) con tiempo. Y sobre todo: ¡La propina (Tip) es obligatoria! En restaurantes se espera entre un 18% y un 20%. Calcula este extra en tu presupuesto diario.</p>
  </div>
</div>
  `
};
...
function App() {
  ...
  // --- FUNCIÓN MAILTO (FORMULARIO EMAIL) ---
  const handleContactSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const confirmSend = window.confirm("Se abrirá tu aplicación de correo para enviar este mensaje. ¿Continuar?");
  ...
  const handleWhatsAppContact = () => {
    const text = `Hola soy cliente, escribo desde la web.\nMe gustaría más información.`;
  ...
  return (
    <Layout onNavigate={scrollToSection}>
      {/* HERO (PORTADA) - AÑADIDO MARGEN SUPERIOR mt-16 PARA QUE NO SE META DEBAJO DEL NAVBAR */}
